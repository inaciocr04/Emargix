...
Route::get('student/signature/create/{attendanceForm}', [StudentSignatureController::class, 'create'])
    ->name('studentSignature.create');

Route::post('/student-signature/store/{studentId}/{attendanceFormId}', [StudentSignatureController::class, 'store'])
